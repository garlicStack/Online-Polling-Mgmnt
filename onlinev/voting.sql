...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2021 at 06:59 AM
...
--
-- Table structure for table `del_candidates`
--

CREATE TABLE `del_candidates` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `del_candidates`
--

INSERT INTO `del_candidates` (`id`, `candidate_name`, `candidate_position`, `candidate_cvotes`) VALUES
(1, 'pizza', 'HOD', 0),
(2, 'pizza', 'HOD', 0);
...
(1, 'Ankeit', 'Parashar', 'ankeit@gmail.com', '9f9ba0a7bd9147303f89e1320735d486'),
...
--
-- Triggers `tbcandidates`
--
DELIMITER $$
CREATE TRIGGER `del_candidates` AFTER DELETE ON `tbcandidates` FOR EACH ROW INSERT into del_candidates(candidate_name, candidate_position, candidate_cvotes) VALUES(old.candidate_name, old.candidate_position, old.candidate_cvotes)
$$
DELIMITER ;
...
(7, 'Ankeit', 'Parashar', 'ankeit@gmail.com', '9f9ba0a7bd9147303f89e1320735d486');
...
--
-- Indexes for table `del_candidates`
--
ALTER TABLE `del_candidates`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `del_candidates`
--
ALTER TABLE `del_candidates`
...
--
ALTER TABLE `tbcandidates`
  MODIFY `candidate_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
